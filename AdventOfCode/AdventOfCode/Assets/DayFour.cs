...
public class DayFour : MonoBehaviour
{
    ...
    void Start()
    {
        foreach (var PairOfRanges in GetFileContents())
        {
            ...
            //in Ranges[0] is the first range, in Ranges[1] is the second range in the format "1-3". If one of the ranges fully contains the other, then the total count is increased by 1.
